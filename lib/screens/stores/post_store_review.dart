...
class PostStoreReview extends StatefulWidget {
  final String storeID;

  PostStoreReview({this.storeID});

  @override
  _PostStoreReviewState createState() => _PostStoreReviewState();
}

class _PostStoreReviewState extends State<PostStoreReview> {
  ...
  proceed() async {
    ...
    await postStoreReview(StoreReview(
      active: true,
